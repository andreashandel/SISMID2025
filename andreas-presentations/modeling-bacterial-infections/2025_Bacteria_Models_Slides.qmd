...
$$
\begin{aligned}
\dot{B_s} & = (1-\mu)g_s B_s(1-\frac{B_s+B_r}{B_{max}}) - \frac{k_s C}{C+C_{50}^s} B_s -k_I I B_s\\
\dot{B_r} & = (\mu g_s B_s + g_r B_r)(1-\frac{B_s+B_r}{B_{max}}) - \frac{k_r C}{C+C_{50}^r} B_r -k_I I B_r\\
